...
import sys
sys.path.insert(0,'/home/bagel1/TeamLiftCSWaterProject/lora')
from sender import sendSensorDataLocal
# Debug msgs
DEBUG = True
...
ports = ("/dev/ttyACM0", "/dev/ttyACM2") # ports used
...
sample_rate = 5 # how many seconds to wait between samples
...
while True:
    ...
    if(len(bytearray(packet,'UTF-8'))>0):
        sendSensorDataLocal(bytearray(packet,'UTF-8'))
